"""
Visual Frame Selector and VACE Inline - ComfyUI nodes for interactive frame selection
and single-video VACE preparation.
"""
...
NODE_CLASS_MAPPINGS = {**VFS_MAPPINGS, **INLINE_MAPPINGS, **OUTPAINT_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**VFS_DISPLAY, **INLINE_DISPLAY, **OUTPAINT_DISPLAY}
