"""
ComfyUI Visual Frame Selector v2
...
from .nodes.frame_selector import VisualFrameSelector
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "VisualFrameSelector": "Visual Frame Selector v2",
}
...
async def query_video(request):
    ...
    try:
        ...
        # Decode test: try to convert the first frame to rgb24.
        # This catches codecs that PyAV can open but not decode (e.g. ffv1).
        try:
            container.seek(0)
