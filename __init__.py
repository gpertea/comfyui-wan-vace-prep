...
NODE_CLASS_MAPPINGS = {**PREP_MAPPINGS, **SMOOTH_MAPPINGS, **EXTEND_MAPPINGS, **LOAD_MAPPINGS, **CONTEXT_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**PREP_DISPLAY, **SMOOTH_DISPLAY, **EXTEND_DISPLAY, **LOAD_DISPLAY, **CONTEXT_DISPLAY}
