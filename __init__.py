...
from .vace_inline import NODE_CLASS_MAPPINGS as INLINE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as INLINE_DISPLAY
...
NODE_CLASS_MAPPINGS = {**JOIN_MAPPINGS, **INLINE_MAPPINGS, **EXTEND_MAPPINGS, **LOAD_MAPPINGS, **CONTEXT_MAPPINGS, **VFS_MAPPINGS, **OVERLAY_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**JOIN_DISPLAY, **INLINE_DISPLAY, **EXTEND_DISPLAY, **LOAD_DISPLAY, **CONTEXT_DISPLAY, **VFS_DISPLAY, **OVERLAY_DISPLAY}
